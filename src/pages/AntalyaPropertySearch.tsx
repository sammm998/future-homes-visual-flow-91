...
import { useNavigate, Link, useLocation, useSearchParams } from '@/lib/router-compat';
...
const AntalyaPropertySearch = () => {
  ...
  const antalyaProperties = useMemo(() => {
    ...
    return (Object.values(uniqueProperties) as any[]).map((property, index) => ({
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="space-y-6">
              {paginatedProperties.map((property, propertyIndex) => <div key={property.id} className="cursor-pointer min-h-[60vh] flex items-center justify-center" onClick={() => handlePropertyClick(property)}>
            ...
            <div className="hidden md:block">
              ...
              <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
                {paginatedProperties.map((property, propertyIndex) => <div key={property.id} className="cursor-pointer" onClick={() => handlePropertyClick(property)}>
