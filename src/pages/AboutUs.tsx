              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a href="tel:+905523032750" className="text-sm text-blue-600 hover:text-blue-800 transition-colors cursor-pointer">
                      +90 552 303 27 50
                    </a>
                  </div>
                  <div className="flex items-center gap-3">
                    <Mail className="w-5 h-5 text-blue-500 flex-shrink-0" />
                    <a href="mailto:info@futurehomesinternational.com" className="text-sm text-blue-600 hover:text-blue-800 transition-colors cursor-pointer break-all">
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a href="tel:+905523032750" className="text-sm text-red-600 hover:text-red-800 transition-colors cursor-pointer">
                      +90 552 303 27 50
                    </a>
                  </div>
                  <div className="flex items-center gap-3">
                    <Mail className="w-5 h-5 text-red-500 flex-shrink-0" />
                    <a href="mailto:info@futurehomesinternational.com" className="text-sm text-red-600 hover:text-red-800 transition-colors cursor-pointer break-all">
                      info@futurehomesinternational.com
                    </a>
                  </div>
                </div>
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-sm break-all">info@futurehomesinternational.com</p>
                  </div>
                </div>
                <div className="mt-6 pt-4 border-t border-border">
                  <p className="text-sm text-muted-foreground text-center">
