...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
      <SEOHead
        title={pageTitle || "About Future Homes International | Leading Global Real Estate Experts"}
        description={
          metaDescription ||
          "Leading international real estate experts since 2010. Property investment opportunities in Turkey, Dubai, Cyprus & Bali with citizenship programs. Trusted by thousands of investors worldwide."
        }
        keywords="Future Homes International, real estate company, property investment experts, international property consultants, Turkish citizenship program, global real estate services"
        canonicalUrl="https://futurehomesinternational.com/about-us"
      />
      <Navigation />
      ...
      <section className="relative py-20 overflow-hidden min-h-screen flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <Badge className="mb-6 px-4 py-2 bg-white/10 text-white border-white/20">About Future Homes</Badge>
            ...
            <p className="text-xl text-white/90 leading-relaxed max-w-3xl mx-auto mb-8">
              {heroSubtitle ||
                "Founder of the company Future Homes, I am proud to accompany you in the search for your future home. We are a European-minded company specialized in the sale of properties in Turkey, France and Dubai."}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact-us"
                className="inline-flex items-center justify-center px-6 py-3 bg-white/10 text-white border border-white/20 font-medium rounded-full hover:bg-white/20 transition-all duration-300 text-sm"
              >
                Contact Us
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <Card className="h-full border-0 bg-gradient-to-br from-card to-card/50 backdrop-blur-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    We conduct business with the highest ethical standards, ensuring transparency and integrity in every
                    interaction
                  </p>
                </CardContent>
              </Card>
          ...
          {teamLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {teamMembers.map((member) => (
                <Card
                  key={member.id}
                  className="group border-0 bg-gradient-to-br from-card to-card/50 backdrop-blur-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"
                >
                  <CardContent className="p-8 text-center">
                    {member.image_url && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <CardContent className="p-8">
                ...
                <div className="mt-6 pt-4 border-t border-border">
                  <p className="text-sm text-muted-foreground text-center">
                    Our main hub for Turkish real estate opportunities and citizenship programs
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="group border-0 bg-gradient-to-br from-card to-card/50 backdrop-blur-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              <CardContent className="p-8">
                ...
                <div className="mt-6 pt-4 border-t border-border">
                  <p className="text-sm text-muted-foreground text-center">
                    Serving the Mediterranean region with premium real estate opportunities
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="group border-0 bg-gradient-to-br from-card to-card/50 backdrop-blur-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              <CardContent className="p-8">
                ...
                <div className="mt-6 pt-4 border-t border-border">
                  <p className="text-sm text-muted-foreground text-center">
                    European headquarters serving international clients across the continent
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="group border-0 bg-gradient-to-br from-card to-card/50 backdrop-blur-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              <CardContent className="p-8">
                ...
                <div className="mt-6 pt-4 border-t border-border">
                  <p className="text-sm text-muted-foreground text-center">
                    Gateway to Middle Eastern luxury properties and investment opportunities
                  </p>
                </div>
              </CardContent>
            </Card>
        ...
        <section className="py-20">
          <Card className="border-0 bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5 backdrop-blur-sm">
            <CardContent className="p-12 text-center">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">9 Languages Spoken</h2>
        ...
        <section className="py-20">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Complete Support Journey</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => (
              <Card
                key={index}
                className="group h-full border-0 bg-gradient-to-br from-card to-card/50 backdrop-blur-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
              >
