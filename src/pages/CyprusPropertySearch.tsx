      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="hidden md:block">
          ...
          <div className="mt-12 p-6 bg-gradient-to-br from-accent/5 to-primary/5 rounded-lg border border-border/20">
            <div className="prose prose-gray max-w-none dark:prose-invert">
              <h2 className="text-2xl font-bold text-foreground mb-4">Cyprus EU Citizenship & Investment Benefits</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">EU Advantages</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">Investment Climate</h3>
                  <ul className="text-muted-foreground space-y-1">
