...
const SEOHead: React.FC<SEOHeadProps> = ({
  ...
  description = "Premium properties in Turkey, Dubai, Cyprus, Antalya, Mersin & France. Expert guidance, citizenship programs & luxury homes. Your investment future starts here.",
