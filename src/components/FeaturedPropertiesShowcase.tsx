      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {featuredProperties.map((property) => (
            <div key={property.id} className="group relative bg-card rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500">
              <div className="relative h-72 overflow-hidden">
                ...
                <div className="absolute top-6 right-6 bg-primary text-primary-foreground px-4 py-2 rounded-full font-bold text-lg shadow-lg">
                  {property.price || property.starting_price_eur ? formatPriceFromString(property.price || property.starting_price_eur || '0', formatPrice) : t('home.price_on_request')}
                </div>
